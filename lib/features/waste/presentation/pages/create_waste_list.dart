  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
          preferredSize: Size.fromHeight(100.h), child: CreateListAppbar()),
      body: SafeArea(
                      ...
                      : () {
                          ...
                          context.read<CreateListingBloc>().add(
                                SubmitListingRequested(
                                  ...
                                  type:
                                      _wasteTypeFromString(selectedWaste),
                                  unit: double.parse(wasteUnitTextEditingController.text.trim()),
    weight: double.parse(wasteWeightTextEditingController.text.trim()),
                                  contactPhone:
