...
import 'package:trash2cash/features/profile/presentation/widgets/create_recycler_account_modal.dart';
...
class RecyclerProfileSetup extends StatefulWidget {
  const RecyclerProfileSetup({super.key});

  @override
  State<RecyclerProfileSetup> createState() => _RecyclerProfileSetupState();
}

class _RecyclerProfileSetupState extends State<RecyclerProfileSetup> {
      ...
      if (profileState.profile.phone == null) {
        ...
        showDialog(
          ...
          builder: (dialogContext) {
            return const CreateRecyclerAccountModal();
          },
        );
      }
    }
                    ...
                    children: [
                      ...
                      BlocConsumer<ProfileBloc, ProfileState>(
                        listener: (context, state) {
                           if (state is ProfileLoadSuccess) {
                 Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=> RecyclerHome()));
                }
